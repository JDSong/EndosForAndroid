...
public class SubActivity1 extends FragmentActivity {
	...
	private static final String HTML_PATH = "html_1/gastricview";
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	subtitles = res.getStringArray(R.array.page1s_subtitles);
    ...
    private void initButton(){
    	...
    	View childLayout = inflater.inflate(R.layout.footer_1, null);
