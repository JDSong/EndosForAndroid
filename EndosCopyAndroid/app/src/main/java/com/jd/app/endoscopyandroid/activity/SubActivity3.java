...
public class SubActivity3 extends FragmentActivity {
	...
	private static final String HTML_PATH = "html_3/ercpview";
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	subtitles = res.getStringArray(R.array.page3s_subtitles);
    ...
    private void initButton(){
    	...
    	View childLayout = inflater.inflate(R.layout.footer_3, null);
