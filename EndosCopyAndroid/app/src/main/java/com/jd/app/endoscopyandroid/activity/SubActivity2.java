...
public class SubActivity2 extends FragmentActivity {
	...
	private static final String HTML_PATH = "html_2/colonview";
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	subtitles = res.getStringArray(R.array.page2s_subtitles);
    ...
    private void initButton(){
    	...
    	View childLayout = inflater.inflate(R.layout.footer_2, null);
